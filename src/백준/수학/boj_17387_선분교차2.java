...
//            System.out.println("bYDot = " + bYDot);
            ...
            //둘이 평행하고 완전 일치
            if (aInclination == bInclination && aYDot == bYDot) {
                if (checkingRange(bx1, by1, ax1, ay1, ax2, ay2) || (checkingRange(bx2, by2, ax1, ay1, ax2, ay2))
                        || checkingRange(ax1, ay1, bx1, by1, bx2, by2) || checkingRange(ax2, ay2, bx1, by1, bx2, by2)) {
                    System.out.println(1);
                } else {
    ...
    private static double getYDot(double inclination, int x, int y) {
        ...
        return (double) y - (double) Math.round(inclination * 100000) / 100000 * x;
    }
    /*
    1 7 2 80
3 5 8 4
